...
will be more deviated from the true value of μ. Therefore, in the case
of this simulation, the sample average across tests for which the null
is reject is larger than the true value of μ.
