...
Based on the plot above, the sample average of μ̂ across tests for which the null is rejected is smaller than the true value of μ. As the null is rejected, compared to the total mean estimate of μ, the sample average will be more deviated from the true value of μ. Furthermore, as the effective size increases, leading to high power of the test, the possibility of rejecting the null increases. This high possibility could also lead to a higher sample average compared to the true μ.