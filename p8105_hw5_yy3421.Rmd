...
Based on the spaghetti plot above, we can oberve that there is a higher average data for the experiment arm. Furthermore, for all participants in the experiment arm, there is a increasing trend in data as we move from week 1 to 8. However, most data among all participants in the control arm remains in the interval 0 to 2.5. This could indicate a influence of treatment on the experimental group compared to the control group.
...
Based on the plot above, the sample average of μ̂ across tests for which the null is rejected is smaller than the true value of μ. As the null is rejected, compared to the total mean estimate of μ, the sample average will be more deviated from the true value of μ. Therefore, in the case of this simulation, the sample average across tests for which the null is reject is larger than the true value of μ.